...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->outlang_def_help = gengetopt_args_info_help[16] ;
  args_info->outlang_map_help = gengetopt_args_info_help[17] ;
  args_info->data_dir_help = gengetopt_args_info_help[18] ;
  args_info->output_dir_help = gengetopt_args_info_help[19] ;
  args_info->lang_def_help = gengetopt_args_info_help[20] ;
  args_info->lang_map_help = gengetopt_args_info_help[21] ;
  args_info->show_lang_elements_help = gengetopt_args_info_help[22] ;
  args_info->infer_lang_help = gengetopt_args_info_help[23] ;
  args_info->line_number_help = gengetopt_args_info_help[25] ;
  args_info->line_number_ref_help = gengetopt_args_info_help[26] ;
  args_info->gen_references_help = gengetopt_args_info_help[27] ;
  args_info->ctags_file_help = gengetopt_args_info_help[28] ;
  args_info->ctags_help = gengetopt_args_info_help[29] ;
  args_info->verbose_help = gengetopt_args_info_help[31] ;
  args_info->statistics_help = gengetopt_args_info_help[32] ;
  args_info->gen_version_help = gengetopt_args_info_help[33] ;
  args_info->check_lang_help = gengetopt_args_info_help[34] ;
  args_info->check_outlang_help = gengetopt_args_info_help[35] ;
  args_info->failsafe_help = gengetopt_args_info_help[36] ;
  args_info->debug_langdef_help = gengetopt_args_info_help[37] ;
  args_info->show_regex_help = gengetopt_args_info_help[38] ;
  ...
  while (1)
    {
      ...
      stop_char = 0;
      c = getopt_long (argc, argv, "hVi:o:s:f:dc:T:t:H:F:nvg::", long_options, &option_index);
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          {
            if (local_args_info.show_lang_elements_given)
              {
          ...
          {
            if (local_args_info.infer_lang_given)
              {
