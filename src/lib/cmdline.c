...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->doc_help = gengetopt_args_info_help[9] ;
  args_info->no_doc_help = gengetopt_args_info_help[10] ;
  args_info->css_help = gengetopt_args_info_help[11] ;
  args_info->title_help = gengetopt_args_info_help[12] ;
  args_info->tab_help = gengetopt_args_info_help[13] ;
  args_info->header_help = gengetopt_args_info_help[14] ;
  args_info->footer_help = gengetopt_args_info_help[15] ;
  args_info->style_file_help = gengetopt_args_info_help[16] ;
  ...
  args_info->gen_version_help = gengetopt_args_info_help[31] ;
  args_info->check_lang_help = gengetopt_args_info_help[32] ;
  args_info->check_outlang_help = gengetopt_args_info_help[33] ;
  args_info->failsafe_help = gengetopt_args_info_help[34] ;
  args_info->debug_langdef_help = gengetopt_args_info_help[35] ;
  args_info->show_regex_help = gengetopt_args_info_help[36] ;
