...
init_help_array(void)
{
  ...
  gengetopt_args_info_help[45] = gengetopt_args_info_detailed_help[49];
  ...
  gengetopt_args_info_help[52] = 0; 
  
}

const char *gengetopt_args_info_help[53];
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->line_range_help = gengetopt_args_info_detailed_help[32] ;
  args_info->line_range_min = 0;
  args_info->line_range_max = 0;
  args_info->range_separator_help = gengetopt_args_info_detailed_help[34] ;
  args_info->range_context_help = gengetopt_args_info_detailed_help[35] ;
  args_info->regex_range_help = gengetopt_args_info_detailed_help[38] ;
  args_info->regex_range_min = 0;
  args_info->regex_range_max = 0;
  args_info->gen_references_help = gengetopt_args_info_detailed_help[41] ;
  args_info->ctags_file_help = gengetopt_args_info_detailed_help[42] ;
  args_info->ctags_help = gengetopt_args_info_detailed_help[43] ;
  args_info->verbose_help = gengetopt_args_info_detailed_help[45] ;
  args_info->quiet_help = gengetopt_args_info_detailed_help[46] ;
  args_info->binary_output_help = gengetopt_args_info_detailed_help[47] ;
  args_info->statistics_help = gengetopt_args_info_detailed_help[49] ;
  args_info->gen_version_help = gengetopt_args_info_detailed_help[50] ;
  args_info->check_lang_help = gengetopt_args_info_detailed_help[51] ;
  args_info->check_outlang_help = gengetopt_args_info_detailed_help[52] ;
  args_info->failsafe_help = gengetopt_args_info_detailed_help[53] ;
  args_info->debug_langdef_help = gengetopt_args_info_detailed_help[54] ;
  args_info->show_regex_help = gengetopt_args_info_detailed_help[55] ;
