...
init_help_array(void)
{
  ...
  gengetopt_args_info_help[33] = gengetopt_args_info_detailed_help[35];
  gengetopt_args_info_help[34] = gengetopt_args_info_detailed_help[36];
  gengetopt_args_info_help[35] = gengetopt_args_info_detailed_help[37];
  ...
  gengetopt_args_info_help[38] = gengetopt_args_info_detailed_help[40];
  gengetopt_args_info_help[39] = gengetopt_args_info_detailed_help[41];
  gengetopt_args_info_help[40] = gengetopt_args_info_detailed_help[42];
  gengetopt_args_info_help[41] = gengetopt_args_info_detailed_help[43];
  gengetopt_args_info_help[42] = gengetopt_args_info_detailed_help[44];
  gengetopt_args_info_help[43] = gengetopt_args_info_detailed_help[45];
  gengetopt_args_info_help[44] = gengetopt_args_info_detailed_help[46];
  gengetopt_args_info_help[45] = gengetopt_args_info_detailed_help[47];
  gengetopt_args_info_help[46] = gengetopt_args_info_detailed_help[48];
  gengetopt_args_info_help[47] = 0; 
  
}

const char *gengetopt_args_info_help[48];
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->src_lang_help = gengetopt_args_info_detailed_help[5] ;
  args_info->lang_list_help = gengetopt_args_info_detailed_help[6] ;
  args_info->outlang_list_help = gengetopt_args_info_detailed_help[7] ;
  args_info->out_format_help = gengetopt_args_info_detailed_help[8] ;
  args_info->doc_help = gengetopt_args_info_detailed_help[9] ;
  args_info->no_doc_help = gengetopt_args_info_detailed_help[10] ;
  args_info->css_help = gengetopt_args_info_detailed_help[11] ;
  args_info->title_help = gengetopt_args_info_detailed_help[12] ;
  args_info->tab_help = gengetopt_args_info_detailed_help[13] ;
  args_info->header_help = gengetopt_args_info_detailed_help[14] ;
  args_info->footer_help = gengetopt_args_info_detailed_help[15] ;
  args_info->style_file_help = gengetopt_args_info_detailed_help[16] ;
  args_info->style_css_file_help = gengetopt_args_info_detailed_help[17] ;
  args_info->style_defaults_help = gengetopt_args_info_detailed_help[18] ;
  args_info->outlang_def_help = gengetopt_args_info_detailed_help[19] ;
  args_info->outlang_map_help = gengetopt_args_info_detailed_help[20] ;
  args_info->data_dir_help = gengetopt_args_info_detailed_help[21] ;
  args_info->output_dir_help = gengetopt_args_info_detailed_help[22] ;
  args_info->lang_def_help = gengetopt_args_info_detailed_help[23] ;
  args_info->lang_map_help = gengetopt_args_info_detailed_help[24] ;
  args_info->show_lang_elements_help = gengetopt_args_info_detailed_help[25] ;
  args_info->infer_lang_help = gengetopt_args_info_detailed_help[26] ;
  args_info->line_number_help = gengetopt_args_info_detailed_help[28] ;
  args_info->line_number_ref_help = gengetopt_args_info_detailed_help[29] ;
  args_info->line_range_help = gengetopt_args_info_detailed_help[30] ;
  args_info->line_range_min = 0;
  args_info->line_range_max = 0;
  args_info->range_separator_help = gengetopt_args_info_detailed_help[32] ;
  args_info->range_context_help = gengetopt_args_info_detailed_help[33] ;
  args_info->gen_references_help = gengetopt_args_info_detailed_help[36] ;
  args_info->ctags_file_help = gengetopt_args_info_detailed_help[37] ;
  args_info->ctags_help = gengetopt_args_info_detailed_help[38] ;
  args_info->verbose_help = gengetopt_args_info_detailed_help[40] ;
  args_info->quiet_help = gengetopt_args_info_detailed_help[41] ;
  args_info->statistics_help = gengetopt_args_info_detailed_help[42] ;
  args_info->gen_version_help = gengetopt_args_info_detailed_help[43] ;
  args_info->check_lang_help = gengetopt_args_info_detailed_help[44] ;
  args_info->check_outlang_help = gengetopt_args_info_detailed_help[45] ;
  args_info->failsafe_help = gengetopt_args_info_detailed_help[46] ;
  args_info->debug_langdef_help = gengetopt_args_info_detailed_help[47] ;
  args_info->show_regex_help = gengetopt_args_info_detailed_help[48] ;
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (check_multiple_option_occurrences(prog_name, args_info->line_range_given, args_info->line_range_min, args_info->line_range_max, "'--line-range'"))
     error = 1;
